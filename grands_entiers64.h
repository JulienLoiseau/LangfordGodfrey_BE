...
constexpr int TAILLE_BASE = 32;
/** @brief Taille réelle utilisable par mots */
constexpr long long BASE = 4294967296;  /* 2^32 = 4,294,967,296 */
/** @brief Nombre de mots dans un LONG */
constexpr int NB_MAX_MOTS = 7;    /* 96 bits pour n=23, 80 pour 20, 56 pour 19, 49 pour 16
						  * 96 = 3 * 32
					      */
...
__host__ __device__ bool LONG_modulo(LONG *a, int nbBits) ; /* modifie le premier argument */
